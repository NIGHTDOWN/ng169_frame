...
class Image 
{
	...
	//保持图片到本地
	public static
	function imgtolocal($path,$type='')
	{
		if($path == "")return false;
if($type==''){
	$attchementdir = 'data/attachment/pc/';
}else{
	$attchementdir = 'data/attachment/pc/'.$type.'/';
}
...
$ext=$matches[2];
	...
	public static
	function makeCut($srcfile, $size = null,$savefile = null)
	{
		$upload_config = parent::$conf;
	...
	public static
	function makeThumb($srcfile, $size = null,$savefile = null)
	{
		$upload_config = parent::$conf;
	...
	public static
	function cut($picname, $x, $y, $tw, $th,$savename = null)
	{
		$source_path   = $picname;
		$target_width  = $tw;
		$target_height = $th;
	...
	public  static
	function _setTransparency($imgSrc,$imgDest,$ext)
	{
